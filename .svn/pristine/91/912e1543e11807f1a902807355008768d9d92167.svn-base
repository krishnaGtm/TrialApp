...
namespace TrialApp.ViewModels
{
    ...
    {
        public TrialEntryAppService TrialAppService { get; set; }
        public AddVarietyPageViewModel()
        {
            AddNewVarietyCommand = new AddNewVariety();
            TrialAppService = new TrialEntryAppService();
            VarietyName = "";
            ConfirmationMessage = "";
        ...
        private class AddNewVariety : ICommand
        {
            ...
            public async void Execute(object parameter)
            {
                ...
                if (await ViewModel.TrialAppService.AddVariety(trialEntry, relationShip) > 0)
                {
