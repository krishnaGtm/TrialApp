...
namespace TrialApp.Entities.Master
{
    ...
    public class FieldSet
    {
        ...
        [XmlElement(ElementName = "ignore3")]
        public int? CropGroupID { get; set; }

        public string CropCode { get; set; }

        public bool CropGroupLevel { get; set; }

        public bool CropLevel { get; set; }
    ...
    public class TraitType
    {
        ...
        [XmlElement(ElementName = "ignore8")]
        public int? CropGroupID { get; set; }
    ...
    public class Trait
    {
        ...
        [XmlElement(ElementName = "ignore13")]
        public int? CropGroupID { get; set; }
